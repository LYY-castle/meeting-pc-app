...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
        'lib/tinySIP/src/dialogs/tsip_dialog_generic__message.js',
        'lib/tinySIP/src/dialogs/tsip_dialog_generic__publish.js',
        'lib/tinySIP/src/dialogs/tsip_dialog_generic__subscribe.js'
    );
}
