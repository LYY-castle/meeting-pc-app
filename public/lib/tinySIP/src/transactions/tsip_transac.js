...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
     'lib/tinySIP/src/transactions/tsip_transac_ict.js',
     'lib/tinySIP/src/transactions/tsip_transac_ist.js',
     'lib/tinySIP/src/transactions/tsip_transac_layer.js',
     'lib/tinySIP/src/transactions/tsip_transac_nict.js',
     'lib/tinySIP/src/transactions/tsip_transac_nist.js'
    )
}
