...
if (navigator.mozGetUserMedia) {
  ...
  var installPlugin = function() {
    ...
    if (
      pluginObj.isWebRtcPlugin ||
      (typeof navigator.plugins !== 'undefined' &&
        (!!navigator.plugins['WebRTC Everywhere'] || navigator.plugins['WebRTC Everywhere Plug-in for Safari']))
    ) {
  ...
  MediaStreamTrack.getSources = function(gotSources) {
    // not part of the standard (at least, haven't found it)
    if (document.readyState !== 'complete') {
