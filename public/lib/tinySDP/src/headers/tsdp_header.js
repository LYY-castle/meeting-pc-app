...
tsdp_header.prototype.tostring_full = function(b_without_crlf, s_endline) {
  return tsk_string_format(
    '{0}={1}{2}',
    this.get_name(),
    this.toString(s_endline),
    b_without_crlf ? '' : s_endline ? s_endline : '\r\n'
  )
}
...
if (!window.__b_release_mode) {
  tsdp_api_add_js_scripts(
    'head',
    'lib/tinySDP/src/headers/tsdp_header_A.js',
    'lib/tinySDP/src/headers/tsdp_header_C.js',
    'lib/tinySDP/src/headers/tsdp_header_M.js',
    'lib/tinySDP/src/headers/tsdp_header_O.js',
    'lib/tinySDP/src/headers/tsdp_header_Str.js', // B, E, I, K, P, R, S, T, U, Z
    'lib/tinySDP/src/headers/tsdp_header_V.js'
  )
}
